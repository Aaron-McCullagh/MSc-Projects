...
$_SESSION['category'] = $categoryfilter;  
...
<div class="container">
    ...
    if($categoryfilter=="allproducts"){
        echo " <h5><strong>Trending Sport Zone Products..</strong></h5><br> ";
    } else{
    ?><h5><strong>Trending <?php echo $categoryfilter?> Products..</strong></h5><br>
        <?php
         }
         ?>
